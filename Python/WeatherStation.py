...
import serial#for interfacing with GPS module via Serial
...
DHTpin=4
port = serial.Serial("/dev/ttyAMA0", baudrate=9600, timeout=1)#the port to which the gps is connected to
def find(str, ch):
...
def main():
	...
	weatherData=[('temperature',temperature),('pressure',pressure),('altitude',altitude),('seapressure',seaLevelPressure),('humidity',DHTHumidity),('latitude',latitude),('longitude',longitude),('lightintensity','0.0'),('co2','0.0'),('rainfall','0.0')]
